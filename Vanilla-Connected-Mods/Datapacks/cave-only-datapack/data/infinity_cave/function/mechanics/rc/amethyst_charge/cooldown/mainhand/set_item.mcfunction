...
$execute on origin run item modify entity @s weapon.mainhand [{"function":"minecraft:set_item","item":"$(id)"},{"function":"minecraft:set_components","components":$(components)}]

execute on origin run function infinity_cave:mechanics/rc/amethyst_charge/exp/mainhand/get