execute store result storage minecraft:random X int 1 run random value -10..10
execute store result storage minecraft:random Y int 1 run random value 13..22
execute store result storage minecraft:random Z int 1 run random value -10..10
